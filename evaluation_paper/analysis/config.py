...
LECTURE_META = {
    ...
    # (cdh) lecture on anticancer drugs. API dates are left at month granularity
    # (the 2026-06 study window) to avoid inventing a precise transcription date
    # that is not separately documented.
    "anticancerdrugs_02": {
